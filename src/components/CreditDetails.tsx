import { Center, Heading, HStack, VStack, Text, Image, Input, Flex, InputGroup, Link, Spacer, InputRightElement, Icon, Button } from "@chakra-ui/react"
    ...
    return (
        <Center>
            <VStack width="500px" padding={5}>
                ...
                <RouterLink to="/games"><Button width="100%" backgroundColor="red" color="white" height="65px" fontSize={24}>Start Membership</Button></RouterLink>
            </VStack>
        </Center>
    )
}
